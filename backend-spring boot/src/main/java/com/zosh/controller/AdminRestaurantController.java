...
public class AdminRestaurantController {
	@Autowired
	private RestaurantService restaurantService;  //here resturant owner can create resturant
	...
	public ResponseEntity<Restaurant> createRestaurant(
			...
			@RequestHeader("Authorization") String jwt) throws UserException { //acess the token

			User user = userService.findUserProfileByJwt(jwt); //get user
