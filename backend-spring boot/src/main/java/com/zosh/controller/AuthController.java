...
//		savedUser.setCart(savedCart);
		...
		String token = jwtProvider.generateToken(authentication); //generate token

		AuthResponse authResponse = new AuthResponse();//auth response
	...
	public ResponseEntity<AuthResponse> signin(@RequestBody LoginRequest loginRequest) {
		...
		String username = loginRequest.getEmail(); //it is connected to request->login request
	...
	private Authentication authenticate(String username, String password) {
		...
		if (!passwordEncoder.matches(password, userDetails.getPassword())) {  //==method cant use here because use cant give bycrypt
