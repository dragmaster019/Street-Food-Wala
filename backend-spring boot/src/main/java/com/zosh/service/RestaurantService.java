...
public interface RestaurantService {
	...
	public RestaurantDto addToFavorites(Long restaurantId,User user) throws RestaurantException; //favorite resturant add

	public Restaurant updateRestaurantStatus(Long id)throws RestaurantException; //update resturant status
}
